...
# message_int = int.from_bytes(message.encode(), 'big') converts the text to an integer.
# After decryption, decrypted_int.to_bytes((decrypted_int.bit_length() + 7) // 8, 'big').decode()
# converts the integer back to text.