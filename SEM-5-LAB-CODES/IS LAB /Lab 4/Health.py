...
class RabinCryptosystem:
    def __init__(self, key_size=1024):#this acts like a constructor
        self.key_size = key_size

    # Generate public and private key pairs using Rabin Cryptosystem
    def generate_keys(self):
        p = sympy.randprime(2 ** (self.key_size // 2 - 1), 2 ** (self.key_size // 2))#generate p and q which satisfy the cond p=q=3 mod 4
